...
struct Superblock {
    ...
    struct IncompatibleFeatures: OptionSet {
        ...
        static let supportedFeatures: IncompatibleFeatures = [.filetype, .needsRecovery, .extents, .enable64BitSize, .flexibleBlockGroups, .metadataChecksumSeedInSuperblock, .largeDirectory, .directoriesCanBeCaseInsensitive]
    }
